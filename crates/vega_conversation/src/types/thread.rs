...
pub struct Thread {
    ...
    pub id: String,
    /// Owning project id (`projects.id`, nullable in storage). An empty value
    /// is the in-memory projection of a standalone task with no binding.
...
impl Thread {
    /// Whether this task has no project binding and belongs in SESSIONS.
    pub fn is_standalone(&self) -> bool {
        self.project_id.is_empty()
    }

    /// Returns the project binding when this is a project task.
    pub fn project_binding(&self) -> Option<&str> {
